...
barplot(tablaIdeologiaTermin1Rel, main = "Gráfico 5: Porcentaje de identificación ideológica por términos - 1",
...
barplot(tablaIdeologiaTermin2Rel, main = "Gráfico 6: Porcentaje de identificación ideológica por términos - 2",
        xlab = "Ideología", ylab = "Porcentaje",
...
barplot(tablaIdeologiaTermin3Rel, main = "Gráfico 6: Porcentaje de identificación ideológica por términos - 3",
        xlab = "Ideología", ylab = "Porcentaje",
...
barplot(MilitanciaPartidoPoliticoRel, main = "Gráfico 2. Porcentaje de si y no",
...
barplot(PreferenciaPartidoFederativoRel, 
        main = "Gráfico 4. Porcentaje de preferencia partidos federativos", 
...
barplot(MilitanciaPartidoFederativoRel, 
        main = "Gráfico 6. Porcentaje de si y no", 
...
barplot(ParticipacionInstanciasUniversitariasRel, 
        main = "Gráfico 8. Porcentaje de si y no", xlab = "Participación", 
