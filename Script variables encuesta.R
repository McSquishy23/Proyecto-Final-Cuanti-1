...
Base_de_Datos_raw$carrera1Cod <- factor(Base_de_Datos_raw$carrera1, 
                                         labels = c("Ciencias Politicas", "Trabajo Social", "Geografia", "Antropologia", "Psicologia", "Comunicacion Colectiva", "Historia", "Derecho",
                                                    ...
                                                    "Administracion Aduanera y Comercio Exterior", "Enseñanza de la filosofia", "Enseñanza de la Matematica",
                                                    "Enseñanza de las Ciencias Naturales", "Biblotecologia", "Diseño plastico", "Artes Dramaticas", "Ingenieria industrial", 
...
tablaprovinciaRel
plot(Base_de_Datos_raw$provinciaCod, main = "Gráfico 1. Originarie de la provincia de:",
...
plot(Base_de_Datos_raw$carrera1Cod, main = "Gráfico 1. Se encuentra empadronade en la carrera de:",
...
plot(Base_de_Datos_raw$id_ideologia_espectroCod, main = "Gráfico 1. Se ubica en:", xlab =
...
plot(Base_de_Datos_raw$pref_partido_polCod, main = "Gráfico 1. Tiene preferencia por el:",
